    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='бюджет указывать в бакинских рублях', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='бюджет указывать в бакинских рублях', verbose_name='Сборы в США')),
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='бюджет указывать в бакинских рублях', verbose_name='Сборы в мире')),
                ('url', models.SlugField(max_length=160, unique=True)),
